...
export default function Contact() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-cus-violet/20 via-background to-cus-orange/20 py-12 sm:py-16 md:py-20 select-none">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
                ...
                >
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-cus-violet via-cus-pink to-cus-orange bg-clip-text text-transparent mb-4 sm:mb-6 mt-10">
                        Get In Touch
                    </h1>
                ...
                >
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-12">
                        ...
                        >
                            <div className="bg-white rounded-2xl p-6 h-full flex flex-col items-center justify-center text-center">
                                ...
                                <a
                                    href="https://chat.whatsapp.com/EXD8uefqrbj2xrgy0rUuHD?mode=ac_t"
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        >
                            <div className="bg-white rounded-2xl p-6 h-full flex flex-col items-center justify-center text-center">
                                ...
                                <p className="text-gray-600 text-lg font-medium mb-4">impulse@bitcollege.in</p>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-2">+91 8240459326</p>
                            <p className="text-gray-600 mb-2">+91 7044957469</p>
                            <p className="text-gray-600 mb-2">+91 8918755751</p>
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-2">Mohit Moitra Mancha</p>
